...
namespace sus.Game.Screens.Play.HUD
{
    public partial class DrawableGameplayLeaderboardScore : CompositeDrawable
    {
        ...
        private void load(OsuColour colours, OsuConfigManager susConfigManager, IAPIProvider api)
        {
            ...
            scoreDisplayMode = susConfigManager.GetBindable<ScoringMode>(OsuSetting.ScoreDisplayMode);
