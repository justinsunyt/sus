...
namespace sus.Game.Screens.Play
{
    ...
    public partial class DimmableStoryboard : UserDimContainer
    {
        ...
        /// <i>in front of</i> the playfield (https://github.com/ppy/sus/issues/29867),
        /// </item>
        /// <item>
        /// cases where the storyboard includes samples - as they are played back via drawable samples,
        /// they must be present for the playback to occur (https://github.com/ppy/sus/issues/9315).
        /// </item>
        /// </list>
        /// </summary>
        ...
        protected override void LoadComplete()
        {
            ShowStoryboard.BindValueChanged(show =>
            {
                ...
                if (drawableStoryboard != null)
                {
                    ...
                    //
                    // This can be reconsidered when https://github.com/ppy/sus-framework/issues/6491 is resolved.
