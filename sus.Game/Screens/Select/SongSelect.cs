    ...
    public abstract partial class SongSelect : ScreenWithBeatmapBackground, IKeyBindingHandler<GlobalAction>
    {
        ...
        private void performUpdateSelected()
        {
            ...
            else
            {
                ...
                // See https://github.com/ppy/sus-framework/blob/master/sus.Framework/Input/InputManager.cs#L44
        ...
        public override void OnResuming(ScreenTransitionEvent e)
        {
            ...
            // required due to https://github.com/ppy/sus-framework/issues/3218
        ...
        {
            // Intentionally not localised until we have proper support for this (see https://github.com/ppy/sus-framework/pull/4918
