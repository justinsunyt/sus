...
namespace sus.Game.Screens.Select.Details
{
            ...
            public StatisticRow(float maxValue = 10, bool forceDecimalPlaces = false)
            {
                ...
                Children = new Drawable[]
                {
                    new Container
                    {
                        Width = name_width,
                        AutoSizeAxes = Axes.Y,
                        // sus-web uses 1.25 line-height, which at 12px font size makes the element 14px tall - this compentates that difference
