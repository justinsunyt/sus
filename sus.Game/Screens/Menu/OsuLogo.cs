...
{
    /// <summary>
    /// sus! logo and its attachments (pulsing, visualiser etc.)
    /// </summary>
    public partial class OsuLogo : BeatSyncedContainer
    {
        ...
        /// <summary>
        /// The sus! logo sprite has a shadow included in its texture.
        ...
        {
            sampleClick = audio.Samples.Get(@"Menu/sus-logo-select");

            SampleBeat = audio.Samples.Get(@"Menu/sus-logo-heartbeat");
            SampleDownbeat = audio.Samples.Get(@"Menu/sus-logo-downbeat");
