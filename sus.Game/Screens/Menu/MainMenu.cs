...
namespace sus.Game.Screens.Menu
{
    public partial class MainMenu : OsuScreen, IHandlePresentBeatmap, IKeyBindingHandler<GlobalAction>, ISamplePlaybackDisabler
    {
        ...
        public override void OnEntering(ScreenTransitionEvent e)
        {
            ...
            if (storage is OsuStorage susStorage && susStorage.Error != OsuStorageError.None)
                dialogOverlay?.Push(new StorageErrorDialog(susStorage, susStorage.Error));
        }
        ...
        protected override void LogoArriving(OsuLogo logo, bool resuming)
        {
            ...
            {
                // copy out old action to avoid accidentally capturing logo.Action in clsusre, causing a self-reference loop.
