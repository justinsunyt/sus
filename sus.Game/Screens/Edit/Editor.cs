...
using sus.Game.Screens.Edit.Verify;
...
namespace sus.Game.Screens.Edit
{
    ...
    public partial class Editor : OsuScreen, IKeyBindingHandler<GlobalAction>, IKeyBindingHandler<PlatformAction>, IBeatSnapProvider, ISamplePlaybackDisabler, IBeatSyncProvider
    {
        ...
        /// </summary>
        /// <remarks>
        /// Historically, sus! beatmaps have an assumption of full system latency baked in.
        ...
        protected override bool OnKeyDown(KeyDownEvent e)
        {
            ...
            switch (e.Key)
            {
                ...
                // Matching sus-stable implementations.
                case Key.Z:
                    if (e.Repeat)
                        return false;
                ...
                case Key.V:
                    ...
                    // Note that in sus-stable subsequent presses when at track end won't return to last object.
        ...
        protected void Clone()
        {
            ...
            // There are a couple of differences from sus!stable's implementation which will require more work to match:
