...
namespace sus.Game.Screens.Edit.Timing
{
    public partial class ControlPointList : CompositeDrawable
    {
        ...
        private void onUndoRedo()
        {
            ...
            // If we don't deselect, things like offset changes could spawn groups to be added from previous states (see https://github.com/ppy/sus/issues/31098).
