...
namespace sus.Game.Screens.OnlinePlay
{
    public partial class OnlinePlaySubScreenStack : OsuScreenStack
    {
        ...
        protected override void ScreenChanged(IScreen prev, IScreen? next)
        {
            ...
            if (next is not OsuScreen susNext)
            ...
            beatmap.Disabled = susNext.DisallowExternalBeatmapRulesetChanges;
            ruleset.Disabled = susNext.DisallowExternalBeatmapRulesetChanges;
            mods.Disabled = susNext.DisallowExternalBeatmapRulesetChanges;
