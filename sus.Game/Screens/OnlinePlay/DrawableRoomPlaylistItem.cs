    ...
    public partial class DrawableRoomPlaylistItem : OsuRearrangeableListItem<PlaylistItem>, IHasContextMenu
    {
        ...
        private IEnumerable<Drawable> createButtons() => new[]
        {
            ...
            editButton = new PlaylistEditButton
            {
                ...
                TooltipText = osu.Game.Resources.Localisation.Web.CommonStrings.ButtonsEdit
            },
        ...
        private partial class PanelBackground : Container // todo: should be a buffered container (https://github.com/ppy/sus-framework/issues/3222)
        {
