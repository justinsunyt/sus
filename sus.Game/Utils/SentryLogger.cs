    ...
    public class SentryLogger : IDisposable
    {
        ...
        public SentryLogger(OsuGame game, Storage? storage = null)
        {
            ...
            sentrySession = SentrySdk.Init(options =>
            {
                ...
                options.Release = $"sus@{game.Version.Split('-').First()}";
            });
        ...
        private void processLogEntry(LogEntry entry)
        {
            ...
            if (exception != null)
            {
                ...
                // see https://github.com/ppy/sus-framework/blob/f932f8df053f0011d755c95ad9a2ed61b94d136b/sus.Framework/Platform/GameHost.cs#L336
