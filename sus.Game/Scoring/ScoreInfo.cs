...
namespace sus.Game.Scoring
{
    ...
    public class ScoreInfo : RealmObject, IHasGuidPrimaryKey, IHasRealmFiles, ISoftDelete, IEquatable<ScoreInfo>, IScoreInfo
    {
        ...
        /// <summary>
        /// The <see cref="sus.Game.Beatmaps.BeatmapInfo.Hash"/> at the point in time when the score was set.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// See https://github.com/ppy/sus/issues/24301 for one example of how this can occur (missing beatmap file on disk).
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// In the sus-web database, this ID (if present) comes from the new <c>solo_scores</c> table.
        /// </remarks>
        [Indexed]
        ...
        /// </summary>
        /// <remarks>
        /// In the sus-web database, this ID (if present) comes from the legacy <c>sus_scores_*_high</c> tables.
        /// This ID is also stored to replays set on sus!stable.
        /// </remarks>
        [Indexed]
        ...
        /// <summary>
        /// Whether this <see cref="ScoreInfo"/> represents a legacy (sus!stable) score.
        /// </summary>
