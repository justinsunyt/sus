    ...
    public abstract class LegacyScoreDecoder
    {
        ...
        public Score Parse(Stream stream)
        {
            ...
            using (SerializationReader sr = new SerializationReader(stream))
            {
                ...
                // In the case where the incoming score has either an sus!stable or old lazer version, we need
...
#pragma warning disable CS0618
            // In sus! and sus!mania, some judgements affect combo but aren't stored to scores.
...
#pragma warning restore CS0618
        ...
        private void readLegacyReplay(Replay replay, StreamReader reader)
        {
            ...
            for (int i = 0; i < frames.Length; i++)
            {
                ...
                // with fractional (float) frame deltas, up until https://github.com/ppy/sus/pull/12583.
            ...
            // https://github.com/peppy/sus-stable-reference/blob/e53980dd76857ee899f66ce519ba1597e7874f28/sus!/GameModes/Play/ReplayWatcher.cs#L62-L67
            ...
            // https://github.com/peppy/sus-stable-reference/blob/e53980dd76857ee899f66ce519ba1597e7874f28/sus!/GameModes/Play/ReplayWatcher.cs#L69-L71
