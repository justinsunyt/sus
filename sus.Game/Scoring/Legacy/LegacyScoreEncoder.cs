...
namespace sus.Game.Scoring.Legacy
{
    public class LegacyScoreEncoder
    {
        ...
        /// <item><description>30000005: Introduce combo exponent in the sus! gamemode. Reconvert all scores.</description></item>
        ...
        /// <item><description>30000007: Adjust sus!mania combo and accuracy portions and judgement scoring values. Reconvert all scores.</description></item>
        ...
        /// <item><description>30000014: Fix edge cases in conversion for sus! scores on selected beatmaps. Reconvert all scores.</description></item>
        /// <item><description>30000015: Fix sus! standardised score estimation algorithm violating basic invariants. Reconvert all scores.</description></item>
        ...
        public LegacyScoreEncoder(Score score, IBeatmap? beatmap)
        {
            ...
            if (!score.ScoreInfo.Ruleset.IsLegacyRuleset())
                throw new ArgumentException(@"Only scores in the sus, taiko, catch, or mania rulesets can be encoded to the legacy score format.", nameof(score));
        }
