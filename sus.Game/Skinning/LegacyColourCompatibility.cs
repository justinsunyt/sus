...
{
    /// <summary>
    /// Compatibility methods to apply sus!stable quirks to colours. Should be used for legacy skins only.
    /// </summary>
    public static class LegacyColourCompatibility
    {
        ...
        /// </summary>
        /// <remarks>
        /// This is equivalent to setting colour post-constructor in sus!stable.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// This is equivalent to setting colour in the constructor in sus!stable.
        /// </remarks>
