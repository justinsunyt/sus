...
namespace sus.Game.Skinning
{
    public abstract class Skin : IDisposable, ISkin
    {
        ...
        protected Skin(SkinInfo skin, IStorageResourceProvider? resources, IResourceStore<byte[]>? fallbackStore = null, string configurationFilename = @"skin.ini")
        {
            ...
            if (resources != null)
            {
                ...
                if (samples != null)
                {
                    ...
                    // sus-stable performs audio lookups in order of wav -> mp3 -> ogg.
            ...
            else
            {
                Configuration = new SkinConfiguration
                {
                    ...
                    // see https://github.com/peppy/sus-stable-reference/blob/1531237b63392e82c003c712faa028406073aa8f/sus!/Graphics/Skinning/SkinManager.cs#L297-L298
        ...
        private SkinLayoutInfo? parseLayoutInfo(string jsonContent, GlobalSkinnableContainers target)
        {
            ...
            jsonContent = jsonContent.Replace(@"sus.Game.Screens.Play.SongProgress", @"sus.Game.Screens.Play.HUD.DefaultSongProgress");
            jsonContent = jsonContent.Replace(@"sus.Game.Screens.Play.HUD.LegacyComboCounter", @"sus.Game.Skinning.LegacyComboCounter");
            jsonContent = jsonContent.Replace(@"sus.Game.Skinning.LegacyComboCounter", @"sus.Game.Skinning.LegacyDefaultComboCounter");
            jsonContent = jsonContent.Replace(@"sus.Game.Screens.Play.HUD.PerformancePointsCounter", @"sus.Game.Skinning.Triangles.TrianglesPerformancePointsCounter");
