...
namespace sus.Game.Skinning
{
    public class LegacySkin : Skin
    {
        ...
        /// <param name="configurationFilename">The user-facing filename of the configuration file to be parsed. Can accept an .sus or skin.ini file.</param>
            ...
            where TValue : notnull
        {
            try
            {
                if (Configuration.ConfigDictionary.TryGetValue(lookup.ToString() ?? string.Empty, out string? val))
                {
                    ...
                    // ..or in some cases 2 (https://github.com/ppy/sus/issues/18579).
