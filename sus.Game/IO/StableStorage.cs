...
{
    /// <summary>
    /// A storage pointing to an sus-stable installation.
    ...
    public class StableStorage : DesktopStorage
    {
        ...
        /// <summary>
        /// Returns a <see cref="Storage"/> pointing to the sus-stable Songs directory.
        /// </summary>
        public Storage GetSongStorage() => new DesktopStorage(songsPath.Value, host);

        private string locateSongsDirectory()
        {
            var configurationFiles = GetFiles(".", $"sus!.{Environment.UserName}.cfg");
