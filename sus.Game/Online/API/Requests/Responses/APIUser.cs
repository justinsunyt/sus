...
namespace sus.Game.Online.API.Requests.Responses
{
    ...
    public class APIUser : IEquatable<APIUser>, IUser
    {
        ...
        // In sus-web, deleted users have a null ID. When deserializing, we ignore the null value and use 1 instead.
        ...
        /// <summary>
        /// From sus-web's perspective, whether a user was recently online.
        ...
        [JsonProperty(@"kudsus")]
        public KudsusCount Kudsus;

        public class KudsusCount
        {
            [JsonProperty(@"total")]
            public int Total;
