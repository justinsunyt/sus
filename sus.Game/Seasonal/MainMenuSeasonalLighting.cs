...
namespace sus.Game.Seasonal
{
    public partial class MainMenuSeasonalLighting : CompositeDrawable
    {
        ...
        private RulesetInfo? susRuleset;
        ...
        {
            // operate in sus! ruleset to keep things simple for now.
            susRuleset = rulesets.GetRuleset(0);
        ...
        protected override void Update()
        {
            ...
            if (susRuleset == null || beatmapClock == null)
                return;
