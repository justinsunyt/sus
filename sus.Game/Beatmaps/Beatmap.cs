...
namespace sus.Game.Beatmaps
{
        ...
        where T : HitObject
    {
        ...
        public double GetMostCommonBeatLength()
        {
            ...
            // Note: This is more accurate and may present different results because sus-stable didn't have the ability to calculate slider durations in this context.
            if (!HitObjects.Any())
                ...
                ControlPointInfo.TimingPoints.Select((t, i) =>
                                {
                                    ...
                                    // sus-stable forced the first control point to start at 0.
                                    // This is reproduced here to maintain compatibility around sus!mania scroll speed and song select display.
