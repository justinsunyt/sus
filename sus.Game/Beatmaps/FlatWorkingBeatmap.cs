...
{
    /// <summary>
    /// A <see cref="WorkingBeatmap"/> which can be constructed directly from an .sus file (via <see cref="FlatWorkingBeatmap(string, int?)"/>)
    /// or an <see cref="IBeatmap"/> instance (via <see cref="FlatWorkingBeatmap(IBeatmap)"/>,
    /// providing an implementation for
    /// <see cref="WorkingBeatmap.GetPlayableBeatmap(sus.Game.Rulesets.IRulesetInfo,System.Collections.Generic.IReadOnlyList{sus.Game.Rulesets.Mods.Mod})"/>.
    /// </summary>
