...
namespace sus.Game.Beatmaps
{
    ...
    /// - Create a playable <see cref="Beatmap"/> via <see cref="GetPlayableBeatmap(sus.Game.Rulesets.IRulesetInfo,System.Collections.Generic.IReadOnlyList{sus.Game.Rulesets.Mods.Mod})"/>.
    /// </summary>
    public interface IWorkingBeatmap
    {
        ...
        /// <see cref="GetPlayableBeatmap(sus.Game.Rulesets.IRulesetInfo,System.Collections.Generic.IReadOnlyList{sus.Game.Rulesets.Mods.Mod},System.Threading.CancellationToken)"/>
        /// overload instead.
        /// </remarks>
