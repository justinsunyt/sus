...
namespace sus.Game.Beatmaps
{
    ...
    public interface IBeatmapDifficultyInfo
    {
        ...
        /// This was known as "SliderMultiplier" in the .sus format and stable editor.
        /// </summary>
        ...
        /// <summary>
        /// Inverse function to <see cref="DifficultyRange(double,sus.Game.Beatmaps.DifficultyRange)"/>.
        /// Maps a value returned by the function above back to the difficulty that produced it.
        /// </summary>
        /// <param name="difficultyValue">The difficulty-dependent value to be unmapped.</param>
