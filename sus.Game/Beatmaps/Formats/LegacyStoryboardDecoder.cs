...
namespace sus.Game.Beatmaps.Formats
{
    public class LegacyStoryboardDecoder : LegacyDecoder<Storyboard>
    {
        ...
        public static void Register()
        {
            ...
            AddDecoder<Storyboard>(@"sus file format v", m => new LegacyStoryboardDecoder(Parsing.ParseInt(m.Split('v').Last())));
            ...
            if (depth == 0)
            {
                ...
                switch (type)
                {
                    case LegacyEventType.Video:
                    {
                        ...
                        // (see https://github.com/ppy/sus/issues/22829#issuecomment-1465552451).
                    ...
                    case LegacyEventType.Animation:
                    {
                        ...
                        if (FormatVersion < 6)
                            // this is random as hell but taken straight from sus-stable.
