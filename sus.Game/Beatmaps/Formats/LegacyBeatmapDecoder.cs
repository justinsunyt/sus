...
namespace sus.Game.Beatmaps.Formats
{
    public class LegacyBeatmapDecoder : LegacyDecoder<Beatmap>
    {
        ...
        /// </summary>
        /// <remarks>
        /// Compare: https://github.com/peppy/sus-stable-reference/blob/master/sus!/GameplayElements/HitObjects/HitObject.cs#L319
        /// </remarks>
        ...
        {
            AddDecoder<Beatmap>(@"sus file format v", m => new LegacyBeatmapDecoder(Parsing.ParseInt(m.Split('v').Last())));
        ...
        /// See also: https://github.com/peppy/sus-stable-reference/blob/0e425c0d525ef21353c8293c235cc0621d28338b/sus!/GameplayElements/Beatmaps/Beatmap.cs#L567-L614
        /// </summary>
        ...
        internal static void ApplyLegacyDefaults(Beatmap beatmap)
        {
            ...
            // in a perfect world this would throw if sus! ruleset couldn't be found,
        ...
        private void handleTimingPoint(string line)
        {
            ...
            // sus!taiko and sus!mania use effect points rather than difficulty points for scroll speed adjustments.
