...
namespace sus.Game.Beatmaps.Drawables
{
    ...
    public partial class BundledBeatmapDownloader : CompositeDrawable
    {
        ...
        private void queueDownloads(string[] sourceFilenames, int? limit = null)
        {
            ...
            try
            {
                // Matches sus-stable, in order to provide new users with roughly the same randomised selection of bundled beatmaps.
         ...
         *    (which is prob fine when maps are presented as user-generated content), but for a new sus! player, it's easy to assume bundled maps are
        ...
        private static readonly string[] bundled_sus =
        {
        ...
        private static readonly string[] bundled_taiko =
        {
            ...
            "1236083 meganeko - Sirius A (sus! edit).osz",
            ...
            "1818361 meganeko - Feral (sus! edit).osz",
