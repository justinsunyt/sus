...
namespace sus.Game.Beatmaps.Drawables
{
    public partial class BeatmapDownloadButton : CompositeDrawable
    {
        ...
        private void load(OsuGame game, BeatmapModelDownloader beatmaps, OsuConfigManager susConfig)
        {
            noVideoSetting = susConfig.GetBindable<bool>(OsuSetting.PreferNoVideo);
