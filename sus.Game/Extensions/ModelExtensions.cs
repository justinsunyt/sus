...
namespace sus.Game.Extensions
{
    ...
    {
        /// <summary>
        /// Get the relative path in sus! storage for this file.
        /// </summary>
        ...
        /// <summary>
        /// Check whether this <see cref="IRulesetInfo"/>'s online ID is within the range that defines it as a legacy ruleset (ie. either sus!, sus!taiko, sus!catch or sus!mania).
        /// </summary>
