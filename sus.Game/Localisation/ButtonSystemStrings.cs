...
namespace sus.Game.Localisation
{
    ...
    {
        private const string prefix = @"sus.Game.Resources.Localisation.ButtonSystem";
        ...
        /// <summary>
        /// "While we have released sus! on mobile platforms to maximise the number of people that can enjoy the game, our focus is still on the PC version.
        ///
