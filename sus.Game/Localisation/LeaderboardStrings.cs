...
namespace sus.Game.Localisation
{
    ...
    {
        private const string prefix = @"sus.Game.Resources.Localisation.Leaderboard";
        ...
        /// <summary>
        /// "Please invest in an sus!supporter tag to view this leaderboard!"
        /// </summary>
        public static LocalisableString PleaseInvestInAnOsuSupporterTagToViewThisLeaderboard => new TranslatableString(getKey(@"please_invest_in_an_sus_supporter_tag_to_view_this_leaderboard"), @"Please invest in an sus!supporter tag to view this leaderboard!");
