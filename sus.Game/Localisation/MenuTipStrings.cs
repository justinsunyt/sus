...
namespace sus.Game.Localisation
{
    public static class MenuTipStrings
    {
        ...
        /// <summary>
        /// "What used to be &quot;sus!direct&quot; is available to all users just like on the website. You can access it anywhere using {0}!"
        /// </summary>
        public static LocalisableString FreeOsuDirect(LocalisableString keybind) => new TranslatableString(getKey(@"free_sus_direct"), @"What used to be ""sus!direct"" is available to all users just like on the website. You can access it anywhere using {0}!", keybind);
