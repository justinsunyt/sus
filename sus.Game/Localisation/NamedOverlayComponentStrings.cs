...
namespace sus.Game.Localisation
{
    ...
    {
        private const string prefix = @"sus.Game.Resources.Localisation.NamedOverlayComponent";
        ...
        /// <summary>
        /// "track recent dev updates in the sus! ecosystem"
        /// </summary>
        public static LocalisableString ChangelogDescription => new TranslatableString(getKey(@"changelog_description"), @"track recent dev updates in the sus! ecosystem");
