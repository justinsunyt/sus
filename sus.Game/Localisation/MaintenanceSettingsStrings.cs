...
namespace sus.Game.Localisation
{
    ...
    {
        private const string prefix = @"sus.Game.Resources.Localisation.MaintenanceSettings";
        ...
        /// <summary>
        /// "The target directory already seems to have an sus! install. Use that data instead?"
        /// </summary>
        public static LocalisableString TargetDirectoryAlreadyInstalledOsu => new TranslatableString(getKey(@"target_directory_already_installed_sus"), @"The target directory already seems to have an sus! install. Use that data instead?");

        /// <summary>
        /// "To complete this operation, sus! will close. Please open it again to use the new data location."
        /// </summary>
        public static LocalisableString RestartAndReOpenRequiredForCompletion => new TranslatableString(getKey(@"restart_and_re_open_required_for_completion"), @"To complete this operation, sus! will close. Please open it again to use the new data location.");
        ...
        /// <summary>
        /// "Please select your sus!stable install location"
        /// </summary>
        public static LocalisableString StableDirectorySelectHeader => new TranslatableString(getKey(@"stable_directory_select_header"), @"Please select your sus!stable install location");
