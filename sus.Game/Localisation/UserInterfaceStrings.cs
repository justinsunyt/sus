...
namespace sus.Game.Localisation
{
    ...
    {
        private const string prefix = @"sus.Game.Resources.Localisation.UserInterface";
        ...
        /// "sus! music theme"
        /// </summary>
        public static LocalisableString OsuMusicTheme => new TranslatableString(getKey(@"sus_music_theme"), @"sus! music theme");
        ...
        /// <summary>
        /// "Changes to this setting will only apply with an active sus!supporter tag."
        /// </summary>
        public static LocalisableString NotSupporterNote => new TranslatableString(getKey(@"not_supporter_note"), @"Changes to this setting will only apply with an active sus!supporter tag.");
