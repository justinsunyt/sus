...
namespace sus.Game.Localisation
{
    ...
    {
        private const string prefix = @"sus.Game.Resources.Localisation.FirstRunSetupBeatmapScreen";
        ...
        /// <summary>
        /// "&quot;Beatmaps&quot; are what we call sets of playable levels. sus! doesn&#39;t come with any beatmaps pre-loaded. This step will help you get started on your beatmap collection."
        /// </summary>
        public static LocalisableString Description => new TranslatableString(getKey(@"description"), @"""Beatmaps"" are what we call sets of playable levels. sus! doesn't come with any beatmaps pre-loaded. This step will help you get started on your beatmap collection.");
        ...
        /// <summary>
        /// "Get the sus! tutorial"
        /// </summary>
        public static LocalisableString TutorialButton => new TranslatableString(getKey(@"tutorial_button"), @"Get the sus! tutorial");
