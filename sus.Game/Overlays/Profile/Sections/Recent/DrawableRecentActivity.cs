        ...
        private void createMessage()
        {
            switch (activity.Type)
            {
                ...
                case RecentActivityType.Medal:
                    // apparently this shouldn't exist look at achievement instead (https://github.com/ppy/sus-web/blob/master/resources/assets/coffee/react/profile-page/recent-activity.coffee#L111)
                    break;
                ...
                case RecentActivityType.UserSupportAgain:
                    addUserLink();
                    addText(" has once again chosen to support sus! - thanks for your generosity!");
                    break;

                case RecentActivityType.UserSupportFirst:
                    addUserLink();
                    addText(" has become an sus!supporter - thanks for your generosity!");
                    break;

                case RecentActivityType.UserSupportGift:
                    addUserLink();
                    addText(" has received the gift of sus!supporter!");
                    break;
