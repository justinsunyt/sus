...
namespace sus.Game.Overlays.Mods
{
    public partial class ModColumn : ModSelectColumn
    {
        ...
        protected override void Update()
        {
            ...
            // (see description of https://github.com/ppy/sus/pull/19783).
            // however, because of that we must also ensure that we signal correct invalidations (https://github.com/ppy/sus-framework/issues/5129).
