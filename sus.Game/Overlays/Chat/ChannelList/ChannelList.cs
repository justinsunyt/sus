...
namespace sus.Game.Overlays.Chat.ChannelList
{
                ...
                scroll = new OsuScrollContainer
                {
                    ...
                    Child = groupFlow = new SearchContainer
                    {
                        ...
                        Children = new Drawable[]
                        {
                            ...
                            // cross-reference for icons: https://github.com/ppy/sus-web/blob/3c9e99eaf4bd9e73d2712f60d67f5bc95f9dfe2b/resources/js/chat/conversation-list.tsx#L13-L19
