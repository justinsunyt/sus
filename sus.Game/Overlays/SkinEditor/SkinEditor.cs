...
using Web = sus.Game.Resources.Localisation.Web;
...
namespace sus.Game.Overlays.SkinEditor
{
    ...
    public partial class SkinEditor : VisibilityContainer, ICanAcceptFiles, IKeyBindingHandler<PlatformAction>, IKeyBindingHandler<GlobalAction>, IEditorChangeHandler
    {
        ...
        private void skinChanged()
        {
            ...
            //
            // See https://github.com/ppy/sus/blob/8e6a4559e3ae8c9892866cf9cf8d4e8d1b72afd0/sus.Game/Skinning/SkinReloadableDrawable.cs#L76.
            Schedule(() =>
            {
