...
namespace sus.Game.Overlays.Wiki.Markdown
{
    public partial class WikiMarkdownImage : OsuMarkdownImage
    {
        ...
        protected override ImageContainer CreateImageContainer(string url)
        {
            ...
            // "/wiki/images/*" is route to fetch wiki image from sus!web server (see: https://github.com/ppy/sus-web/blob/4205eb66a4da86bdee7835045e4bf28c35456e04/routes/web.php#L289)
