...
namespace sus.Game.Overlays.Settings.Sections.Input
{
    public partial class MouseSettings : SettingsSubsection
    {
        ...
        private void load(OsuConfigManager susConfig, FrameworkConfigManager config)
        {
            ...
            Children = new Drawable[]
            {
                ...
                confineMouseModeSetting = new SettingsEnumDropdown<OsuConfineMouseMode>
                {
                    ...
                    Current = susConfig.GetBindable<OsuConfineMouseMode>(OsuSetting.ConfineMouseMode)
                },
                new SettingsCheckbox
                {
                    LabelText = MouseSettingsStrings.DisableMouseWheelVolumeAdjust,
                    TooltipText = MouseSettingsStrings.DisableMouseWheelVolumeAdjustTooltip,
                    Current = susConfig.GetBindable<bool>(OsuSetting.MouseDisableWheel)
                },
                new SettingsCheckbox
                {
                    LabelText = MouseSettingsStrings.DisableClicksDuringGameplay,
                    Current = susConfig.GetBindable<bool>(OsuSetting.MouseDisableButtons)
                },
            };
        }
