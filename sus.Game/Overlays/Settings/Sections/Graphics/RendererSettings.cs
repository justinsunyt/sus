...
namespace sus.Game.Overlays.Settings.Sections.Graphics
{
    public partial class RendererSettings : SettingsSubsection
    {
        ...
        private void load(FrameworkConfigManager config, OsuConfigManager susConfig, IDialogOverlay? dialogOverlay, OsuGame? game, GameHost host)
        {
...
#pragma warning restore CS0612 // Type or member is obsolete
                ...
                new SettingsCheckbox
                {
                    ...
                    Current = susConfig.GetBindable<bool>(OsuSetting.ShowFpsDisplay)
                },
            };
