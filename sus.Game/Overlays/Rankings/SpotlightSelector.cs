        ...
        private partial class SpotlightsDropdown : OsuDropdown<APISpotlight>
        {
            ...
            private partial class SpotlightsDropdownHeader : OsuDropdownHeader
            {
                public SpotlightsDropdownHeader()
                {
                    ...
                    Text.Padding = new MarginPadding { Vertical = 1.5f }; // sus-web line-height difference compensation
                ...
                private void load(OverlayColourProvider colourProvider)
                {
                    ...
                    // sus-web adds a 0.6 opacity container on top of the 0.5 base one when hovering, 0.8 on a single container here matches the resulting colour
