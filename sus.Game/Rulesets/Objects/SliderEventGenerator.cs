...
namespace sus.Game.Rulesets.Objects
{
    public static class SliderEventGenerator
    {
        ...
        /// These days, this is implemented in the drawable implementation of Slider in the sus! ruleset.
        ///
        /// We need to keep the <see cref="SliderEventType.LegacyLastTick"/> *only* for sus!catch conversion, which relies on it to generate tiny ticks
        /// correctly.
        /// </summary>
                                                                  ...
                                                                  CancellationToken cancellationToken = default)
        {
            ...
            // Times were simpler. sus! was but in its infancy and sliders were a new concept.
