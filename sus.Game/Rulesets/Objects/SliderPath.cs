...
namespace sus.Game.Rulesets.Objects
{
    public class SliderPath
    {
        ...
        private List<Vector2> calculateSubPath(ReadOnlySpan<Vector2> subControlPoints, PathType type)
        {
            switch (type.Type)
            {
                ...
                case SplineType.PerfectCurve:
                {
                    ...
                    // taken from https://github.com/ppy/sus-framework/blob/1201e641699a1d50d2f6f9295192dad6263d5820/sus.Framework/Utils/PathApproximator.cs#L181-L186
                ...
                case SplineType.Catmull:
                {
                    ...
                    // At draw time, sus!stable optimises paths by only keeping piecewise segments that are 6px apart.
        ...
        private void calculateLength()
        {
            ...
            {
                // In sus-stable, if the last two path points of a slider are equal, extension is not performed.
