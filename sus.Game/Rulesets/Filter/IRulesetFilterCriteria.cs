...
namespace sus.Game.Rulesets.Filter
{
    /// <summary>
    ...
    public interface IRulesetFilterCriteria
    {
        ...
        /// along with <see cref="FilterQueryParser.TryUpdateCriteriaRange{T}(ref sus.Game.Screens.Select.FilterCriteria.OptionalRange{T},sus.Game.Screens.Select.Filter.Operator,string,FilterQueryParser.TryParseFunction{T})"/>
