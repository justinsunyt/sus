...
using sus.Game.Rulesets.Filter;
...
namespace sus.Game.Rulesets
{
    public abstract class Ruleset
    {
        ...
        /// See https://github.com/ppy/sus/wiki/Breaking-Changes for full details on required ongoing changes.
        /// </remarks>
        ...
        /// <summary>
        /// For rulesets which support legacy (sus-stable) replay conversion, this method will create an empty replay frame
        /// for conversion use.
        /// </summary>
