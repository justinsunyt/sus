...
namespace sus.Game.Rulesets.Mods
{
    public abstract class ModClassic : Mod
    {
        ...
        /// Right now classic mods are considered, for leaderboard purposes, to be equal as scores set on sus-stable.
        /// But this is not the case.
        ///
        /// Some examples for things to resolve before even considering this:
        ///  - Hit windows differ (https://github.com/ppy/sus/issues/11311).
        ///  - Sliders always gives combo for slider end, even on miss (https://github.com/ppy/sus/issues/11769).
        /// </summary>
