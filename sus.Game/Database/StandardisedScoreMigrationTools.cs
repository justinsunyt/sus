...
namespace sus.Game.Database
{
    public static class StandardisedScoreMigrationTools
    {
        ...
        /// See: https://github.com/ppy/sus-queue-score-statistics/blob/3681e92ac91c6c61922094bdbc7e92e6217dd0fc/sus.Server.Queues.ScoreStatisticsProcessor/Commands/Queue/BatchInserter.cs
        /// </remarks>
        /// <param name="score">The score to update.</param>
                                                                                     ...
                                                                                     LegacyScoreAttributes attributes)
        {
            ...
            switch (score.Ruleset.OnlineID)
            {
                case 0:
                    ...
                    // but in practice this appears to fail for some scores (https://github.com/ppy/sus/pull/25876#issuecomment-1862248413).
