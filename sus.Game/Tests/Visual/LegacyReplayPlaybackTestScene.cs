...
{
    /// <summary>
    /// The goal of this abstract test class is to exercise correct playback of replays sourced from previous sus! versions.
    ...
    public abstract partial class LegacyReplayPlaybackTestScene : RateAdjustedBeatmapTestScene
    {
        ...
        /// <summary>
        /// This is provided as a convenience for testing behaviour against sus!stable.
        ...
        protected void RunTest(string beatmapName, IBeatmap beatmap, string replayName, Score originalScore, IEnumerable<HitResult> expectedResults)
        {
            ...
            if (ExportLocation != null)
            {
                ...
                {
                    using var stream = File.Open(Path.Combine(ExportLocation, $"{beatmapName}.sus"), FileMode.Create);
