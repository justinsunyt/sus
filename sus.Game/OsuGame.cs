...
using Sentry;
using MatchType = sus.Game.Online.Rooms.MatchType;

namespace sus.Game
{
    /// <summary>
    /// The full sus! experience. Builds on top of <see cref="OsuGameBase"/> to add menus and binding logic
    ...
    public partial class OsuGame : OsuGameBase, IKeyBindingHandler<GlobalAction>, ILocalUserPlayInfo, IPerformFromScreenRunner, IOverlayManager, ILinkHandler
    {
        ...
        public const string IPC_PIPE_NAME = "sus-lazer-debug";
#else
        public const string IPC_PIPE_NAME = "sus-lazer";
#endif
        ...
        private void load()
        {
            ...
            if (SeasonalUIConfig.ENABLED)
                dependencies.CacheAs(susLogo = new OsuLogoChristmas { Alpha = 0 });
            else
                dependencies.CacheAs(susLogo = new OsuLogo { Alpha = 0 });
        ...
        protected override IDictionary<FrameworkSetting, object> GetFrameworkConfigDefaults()
        {
            ...
            {
                // General expectation that sus! starts in fullscreen by default (also gives the most predictable performance).
        ...
        protected override void LoadComplete()
        {
            ...
            loadComponentSingleFile(susLogo, _ =>
            {
                susLogo.SetupDefaultContainer(logoContainer);
        ...
        public bool OnPressed(KeyBindingPressEvent<GlobalAction> e)
        {
            ...
            switch (e.Action)
            {
                ...
                case GlobalAction.RandomSkin:
                    ...
                    // This is mainly to stop many "sus! default (modified)" skins being created via the SkinManager.EnsureMutableSkin() path.
