...
namespace sus.Game.Graphics.UserInterfaceV2
{
    public partial class OsuHSVColourPicker : HSVColourPicker
    {
        ...
        private void load(OverlayColourProvider? colourProvider, OsuColour susColour)
        {
            Background.Colour = colourProvider?.Dark5 ?? susColour.GreySeaFoamDark;
        ...
        private partial class OsuHueSelector : HueSelector
        {
            ...
            private partial class SliderNub : CompositeDrawable
            {
                ...
                public SliderNub(OsuHueSelector susHueSelector)
                {
                    hue = susHueSelector.Hue.GetBoundCopy();
