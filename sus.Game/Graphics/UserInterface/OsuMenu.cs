...
namespace sus.Game.Graphics.UserInterface
{
    public partial class OsuMenu : Menu
    {
        ...
        // todo: this shouldn't be required after https://github.com/ppy/sus-framework/issues/4519 is fixed.
        ...
        protected override void Update()
        {
            ...
            foreach (var drawableItem in ItemsContainer)
            {
                if (drawableItem is DrawableOsuMenuItem susItem)
                    susItem.ShowCheckbox.Value = showCheckboxes;
            }
        }
