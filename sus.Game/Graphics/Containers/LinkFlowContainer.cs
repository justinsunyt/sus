...
namespace sus.Game.Graphics.Containers
{
    public partial class LinkFlowContainer : OsuTextFlowContainer
    {
        ...
        private partial class LinkFlow : InnerFlow
        {
            ...
            // However due to https://github.com/ppy/sus-framework/issues/2073, it's possible for the compilers to be relative size in the flow's auto-size axes - an unsupported operation.
