...
namespace sus.Game.Graphics.Containers.Markdown
{
    public partial class OsuMarkdownHeading : MarkdownHeading
    {
        ...
        protected override float GetFontSizeByLevel(int level)
        {
            ...
            // https://github.com/ppy/sus-web/blob/376cac43a051b9c85ce95e2c446099be187b3e45/resources/assets/less/bem/sus-md.less#L9
            // https://github.com/ppy/sus-web/blob/376cac43a051b9c85ce95e2c446099be187b3e45/resources/assets/less/variables.less#L161
            switch (level)
            {
                case 1:
                    return 30;
