...
namespace sus.Game.Rulesets.Taiko.Objects.Drawables
{
    public abstract partial class DrawableTaikoHitObject : DrawableHitObject<TaikoHitObject>, IKeyBindingHandler<TaikoAction>
    {
        ...
        /// </summary>
        /// <remarks>
        /// This is how sus-stable worked, but notably is not how TnT works.
        ...
        // sus!taiko hitsounds are managed by the drum (see DrumSampleTriggerSource).
        ...
        where TObject : TaikoHitObject
    {
        ...
        protected override void OnApply()
        {
            ...
            // TODO: THIS CANNOT BE HERE, it makes pooling pointless (see https://github.com/ppy/sus/issues/21072).
            RecreatePieces();
        }
