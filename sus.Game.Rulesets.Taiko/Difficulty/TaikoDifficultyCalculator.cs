...
using sus.Game.Rulesets.Taiko.Difficulty.Preprocessing;
using sus.Game.Rulesets.Taiko.Difficulty.Preprocessing.Colour;
using sus.Game.Rulesets.Taiko.Difficulty.Preprocessing.Rhythm;
using sus.Game.Rulesets.Taiko.Difficulty.Skills;
using sus.Game.Rulesets.Taiko.Mods;
using sus.Game.Rulesets.Taiko.Scoring;

namespace sus.Game.Rulesets.Taiko.Difficulty
{
    public class TaikoDifficultyCalculator : DifficultyCalculator
    {
        ...
        protected override DifficultyAttributes CreateDifficultyAttributes(IBeatmap beatmap, Mod[] mods, Skill[] skills, double clockRate)
        {
            ...
            // As we don't have pattern integration in sus!taiko, we apply the other two skills relative to rhythm.
