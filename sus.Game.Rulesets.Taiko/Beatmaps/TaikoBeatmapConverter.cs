...
namespace sus.Game.Rulesets.Taiko.Beatmaps
{
    ...
    {
        /// <summary>
        /// A speed multiplier applied globally to sus!taiko.
        /// </summary>
        /// <remarks>
        /// sus! is generally slower than taiko, so a factor was historically added to increase speed for converts.
        ...
        /// <summary>
        /// Because swells are easier in taiko than spinners are in sus!,
        ...
        /// <summary>
        /// Base sus! slider scoring distance.
        /// </summary>
        private const float sus_base_scoring_distance = 100;
        ...
        {
            // Old sus! used hit sounding to determine various hit type information
        ...
        private bool shouldConvertSliderToHits(HitObject obj, IBeatmap beatmap, IHasPath pathData, out int taikoDuration, out double tickSpacing)
        {
            ...
            double sliderScoringPointDistance = sus_base_scoring_distance * (beatmap.Difficulty.SliderMultiplier * VELOCITY_MULTIPLIER) / beatmap.Difficulty.SliderTickRate;
            ...
            double susVelocity = taikoVelocity * (1000f / beatLength);

            // sus-stable always uses the speed-adjusted beatlength to determine the sus! velocity, but only uses it for conversion if beatmap version < 8
            ...
            return tickSpacing > 0
                   && distance / susVelocity * 1000 < 2 * beatLength;
        }
