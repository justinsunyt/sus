...
namespace sus.Android
{
    ...
    [IntentFilter(new[] { Intent.ActionView }, Categories = new[] { Intent.CategoryDefault }, DataScheme = "content", DataMimeType = "application/x-sus-beatmap-archive")]
    [IntentFilter(new[] { Intent.ActionView }, Categories = new[] { Intent.CategoryDefault }, DataScheme = "content", DataMimeType = "application/x-sus-skin-archive")]
    [IntentFilter(new[] { Intent.ActionView }, Categories = new[] { Intent.CategoryDefault }, DataScheme = "content", DataMimeType = "application/x-sus-replay")]
    ...
    [IntentFilter(new[] { Intent.ActionView }, Categories = new[] { Intent.CategoryBrowsable, Intent.CategoryDefault }, DataSchemes = new[] { "sus", "susmp" })]
    public class OsuGameActivity : AndroidGameActivity
    {
        private static readonly string[] sus_url_schemes = { "sus", "susmp" };
...
#pragma warning restore CA1422
            ...
            // Don't forget sus.Game.Tests.Android too.
        ...
        private void handleIntent(Intent? intent)
        {
            ...
            switch (intent.Action)
            {
                case Intent.ActionDefault:
                    ...
                    else if (sus_url_schemes.Contains(intent.Scheme))
                    {
