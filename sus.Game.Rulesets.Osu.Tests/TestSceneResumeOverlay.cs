...
namespace sus.Game.Rulesets.Osu.Tests
{
    ...
    {
        private ManualOsuInputManager susInputManager = null!;
        ...
        public void TestResume(float cursorSize)
        {
            ...
            AddStep("click", () => susInputManager.GameClick());
        ...
        {
            Child = susInputManager = new ManualOsuInputManager(new OsuRuleset().RulesetInfo)
            {
