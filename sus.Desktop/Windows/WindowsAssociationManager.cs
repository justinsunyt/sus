...
namespace sus.Desktop.Windows
{
    ...
    public static class WindowsAssociationManager
    {
        ...
        /// </summary>
        private const string program_id_file_prefix = "sus.File";

        private const string program_id_protocol_prefix = "sus.Uri";

        private static readonly ApplicationCapability application_capability = new ApplicationCapability(@"sus", @"Software\ppy\sus\Capabilities", "sus!(lazer)");
        ...
        {
            new UriAssociation(@"sus", WindowsAssociationManagerStrings.OsuProtocol, Icons.Lazer),
            new UriAssociation(@"susmp", WindowsAssociationManagerStrings.OsuMultiplayer, Icons.Lazer),
        };
