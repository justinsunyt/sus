...
using UpdateManager = sus.Game.Updater.UpdateManager;

namespace sus.Desktop.Updater
{
    public partial class VelopackUpdateManager : UpdateManager
    {
        ...
        protected override async Task<bool> PerformUpdateCheck(CancellationToken cancellationToken)
        {
            ...
            try
            {
                IUpdateSource updateSource = new GithubSource(@"https://github.com/ppy/sus", null, ReleaseStream.Value == Game.Configuration.ReleaseStream.Tachyon);
