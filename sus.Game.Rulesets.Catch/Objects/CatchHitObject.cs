...
namespace sus.Game.Rulesets.Catch.Objects
{
    public abstract class CatchHitObject : HitObject, IHasPosition, IHasComboInformation, IHasTimePreempt
    {
        ...
        {
            // Note that this implementation is shared with the sus! ruleset's implementation.
        ...
        // The half of the height of the sus! playfield.
        ...
        /// <summary>
        /// The Y position of the hit object is not used in the normal sus!catch gameplay.
