...
using sus.Game.Rulesets.Catch.Edit.Setup;
using sus.Game.Rulesets.Catch.Mods;
using sus.Game.Rulesets.Catch.Objects;
using sus.Game.Rulesets.Catch.Replays;
using sus.Game.Rulesets.Catch.Scoring;
using sus.Game.Rulesets.Catch.Skinning.Argon;
...
namespace sus.Game.Rulesets.Catch
{
    public class CatchRuleset : Ruleset, ILegacyRuleset
    {
        ...
        public override string Description => "sus!catch";
