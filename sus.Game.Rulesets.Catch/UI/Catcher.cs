...
namespace sus.Game.Rulesets.Catch.UI
{
    ...
    public partial class Catcher : SkinReloadableDrawable
    {
        ...
        /// This is also equivalent to the "catcherWidth" property in sus-stable when the game field and beatmap difficulty are set to default values.
        /// </remarks>
        ...
        /// <summary>
        /// The width of the catcher which can receive fruit. Equivalent to "catchMargin" in sus-stable.
        /// </summary>
        ...
        {
            // this is taken from sus-stable (lenience should be 10 * 10 at standard scale).
