...
namespace sus.Game.Rulesets.Catch.UI
{
    public partial class CatchPlayfieldAdjustmentContainer : PlayfieldAdjustmentContainer
    {
        ...
        private void load(OsuGame? susGame)
        {
            if (susGame != null)
            {
                ...
                float aspectRatio = susGame.ScalingContainerTargetDrawSize.X / susGame.ScalingContainerTargetDrawSize.Y;
        ...
        private partial class ScalingContainer : Container
        {
            ...
            protected override void Update()
            {
                ...
                // see: https://github.com/peppy/sus-stable-reference/blob/1531237b63392e82c003c712faa028406073aa8f/sus!/GameplayElements/HitObjects/Fruits/HitCircleFruits.cs#L65
