    ...
    public class CatchBeatmapProcessor : BeatmapProcessor
    {
                ...
                switch (obj)
                {
                    ...
                    case BananaShower bananaShower:
                        foreach (var banana in bananaShower.NestedHitObjects.OfType<Banana>())
                        {
                            ...
                            rng.Next(); // sus!stable retrieved a random banana type
                            rng.Next(); // sus!stable retrieved a random banana rotation
                            rng.Next(); // sus!stable retrieved a random banana colour
                        }
                    ...
                    case JuiceStream juiceStream:
                        ...
                        foreach (var nested in juiceStream.NestedHitObjects)
                        {
                            ...
                            if (catchObject is TinyDroplet)
                                ...
                                rng.Next(); // sus!stable retrieved a random droplet rotation
                        }
        ...
        private static void applyHardRockOffset(CatchHitObject hitObject, ref float? lastPosition, ref double lastStartTime, LegacyRandom rng)
        {
            ...
            if (lastPosition == null ||
                ...
                // reference: https://github.com/peppy/sus-stable-reference/blob/3ea48705eb67172c430371dcfc8a16a002ed0d3d/sus!/GameplayElements/HitObjects/Fruits/HitFactoryFruits.cs#L45-L50
        ...
        private static void initialiseHyperDash(IBeatmap beatmap)
        {
            ...
            // Todo: This is wrong. sus!stable calculated hyperdashes using the full catcher size, excluding the margins.
            ...
            for (int i = 0; i < palpableObjects.Length - 1; i++)
            {
                ...
                // Int truncation added to match sus!stable.
                double timeToNext = (int)nextObject.StartTime - (int)currentObject.StartTime - 1000f / 60f / 4; // 1/4th of a frame of grace time, taken from sus-stable
