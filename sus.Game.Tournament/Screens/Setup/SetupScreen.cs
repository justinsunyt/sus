        ...
        private void reload()
        {
            ...
            fillFlow.Children = new Drawable[]
            {
                new ActionableInfo
                {
                    ...
                    Description =
                        "The sus!stable installation which is currently being used as a data source. If a source is not found, make sure you have created an empty ipc.txt in your stable cutting-edge installation."
                },
                new ActionableInfo
                {
                    Label = "Current user",
