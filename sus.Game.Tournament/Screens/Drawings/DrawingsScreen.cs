...
namespace sus.Game.Tournament.Screens.Drawings
{
    public partial class DrawingsScreen : TournamentScreen
    {
        ...
        private void load(Storage storage)
        {
            ...
            if (!TeamList.Teams.Any())
            {
                ...
                links.AddLink("Click for details on the file format", "https://sus.ppy.sh/wiki/en/Tournament_Drawings", t => t.Colour = Color4.White);
                return;
            }
