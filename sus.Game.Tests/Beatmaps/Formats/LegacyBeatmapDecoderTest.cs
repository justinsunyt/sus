...
namespace sus.Game.Tests.Beatmaps.Formats
{
    ...
    public class LegacyBeatmapDecoderTest
    {
        ...
        {
            using (var resStream = TestResources.OpenResource("beatmap-version-6.sus"))
        ...
        {
            using (var resStream = TestResources.OpenResource("beatmap-version-4.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var decoder = Decoder.GetDecoder<Beatmap>(stream);
        ...
        public void TestDecodeBeatmapGeneral()
        {
            ...
            using (var resStream = TestResources.OpenResource("Soleily - Renatus (Gamu) [Insane].sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
        ...
        public void TestDecodeOverlappingTimingPoints()
        {
            ...
            using (var resStream = TestResources.OpenResource("overlapping-control-points.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
        ...
        public void TestDecodeOmitBarLineEffect()
        {
            ...
            using (var resStream = TestResources.OpenResource("omit-barline-control-points.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var controlPoints = (LegacyControlPointInfo)decoder.Decode(stream).ControlPointInfo;
        ...
        public void TestTimingPointResetsSpeedMultiplier()
        {
            ...
            using (var resStream = TestResources.OpenResource("timingpoint-speedmultiplier-reset.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var controlPoints = (LegacyControlPointInfo)decoder.Decode(stream).ControlPointInfo;
        ...
        public void TestComboColourCountIsLimitedToEight()
        {
            ...
            using (var resStream = TestResources.OpenResource("too-many-combo-colours.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var comboColors = decoder.Decode(stream).ComboColours;
        ...
        public void TestGetLastObjectTime()
        {
            ...
            using (var resStream = TestResources.OpenResource("mania-last-object-not-latest.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var beatmap = decoder.Decode(stream);
        ...
        public void TestDecodeBeatmapComboOffsetsOsu()
        {
            ...
            using (var resStream = TestResources.OpenResource("hitobject-combo-offset.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var beatmap = decoder.Decode(stream);
        ...
        public void TestDecodeBeatmapHitObjectCoordinatesLegacy()
        {
            ...
            using (var resStream = TestResources.OpenResource("hitobject-coordinates-legacy.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
        ...
        public void TestDecodeBeatmapHitObjectCoordinatesLazer()
        {
            ...
            using (var resStream = TestResources.OpenResource("hitobject-coordinates-lazer.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var hitObjects = decoder.Decode(stream).HitObjects;
        ...
        public void TestDecodeControlPointDifficultyChange()
        {
            ...
            using (var resStream = TestResources.OpenResource("controlpoint-difficulty-multiplier.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
        ...
        public void TestDecodeControlPointCustomSampleBank()
        {
            ...
            using (var resStream = TestResources.OpenResource("controlpoint-custom-samplebank.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var hitObjects = decoder.Decode(stream).HitObjects;
        ...
        public void TestDecodeHitObjectCustomSampleBank()
        {
            ...
            using (var resStream = TestResources.OpenResource("hitobject-custom-samplebank.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var hitObjects = decoder.Decode(stream).HitObjects;
        ...
        public void TestDecodeHitObjectFileSamples()
        {
            ...
            using (var resStream = TestResources.OpenResource("hitobject-file-samples.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var hitObjects = decoder.Decode(stream).HitObjects;
        ...
        public void TestDecodeSliderSamples()
        {
            ...
            using (var resStream = TestResources.OpenResource("slider-samples.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var hitObjects = decoder.Decode(stream).HitObjects;
        ...
        public void TestDecodeHitObjectNullAdditionBank()
        {
            ...
            using (var resStream = TestResources.OpenResource("hitobject-no-addition-bank.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var hitObjects = decoder.Decode(stream).HitObjects;
        ...
        public void TestInvalidEventStillPasses()
        {
            ...
            using (var badResStream = TestResources.OpenResource("invalid-events.sus"))
        ...
        public void TestInvalidBankDefaultsToNormal()
        {
            ...
            using (var resStream = TestResources.OpenResource("invalid-bank.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var hitObjects = decoder.Decode(stream).HitObjects;
        ...
        public void TestFallbackDecoderForCorruptedHeader()
        {
            ...
            using (var resStream = TestResources.OpenResource("corrupted-header.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
        ...
        public void TestFallbackDecoderForMissingHeader()
        {
            ...
            using (var resStream = TestResources.OpenResource("missing-header.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                Assert.DoesNotThrow(() => decoder = Decoder.GetDecoder<Beatmap>(stream));
                Assert.IsInstanceOf<LegacyBeatmapDecoder>(decoder);
        ...
        public void TestDecodeFileWithEmptyLinesAtStart()
        {
            ...
            using (var resStream = TestResources.OpenResource("empty-lines-at-start.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                Assert.DoesNotThrow(() => decoder = Decoder.GetDecoder<Beatmap>(stream));
                Assert.IsInstanceOf<LegacyBeatmapDecoder>(decoder);
        ...
        public void TestDecodeFileWithEmptyLinesAndNoHeader()
        {
            ...
            using (var resStream = TestResources.OpenResource("empty-line-instead-of-header.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                Assert.DoesNotThrow(() => decoder = Decoder.GetDecoder<Beatmap>(stream));
                Assert.IsInstanceOf<LegacyBeatmapDecoder>(decoder);
        ...
        public void TestDecodeFileWithContentImmediatelyAfterHeader()
        {
            ...
            using (var resStream = TestResources.OpenResource("no-empty-line-after-header.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                Assert.DoesNotThrow(() => decoder = Decoder.GetDecoder<Beatmap>(stream));
                Assert.IsInstanceOf<LegacyBeatmapDecoder>(decoder);
        ...
        public void TestMultiSegmentSliders()
        {
            ...
            using (var resStream = TestResources.OpenResource("multi-segment-slider.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
        ...
        public void TestSliderLengthExtensionEdgeCase()
        {
            ...
            using (var resStream = TestResources.OpenResource("duplicate-last-position-slider.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var decoded = decoder.Decode(stream);
        ...
        public void TestUndefinedApproachRateInheritsOverallDifficulty()
        {
            ...
            using (var resStream = TestResources.OpenResource("undefined-approach-rate.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var decoded = decoder.Decode(stream);
        ...
        public void TestApproachRateDefinedBeforeOverallDifficulty()
        {
            ...
            using (var resStream = TestResources.OpenResource("approach-rate-before-overall-difficulty.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var decoded = decoder.Decode(stream);
        ...
        public void TestApproachRateDefinedAfterOverallDifficulty()
        {
            ...
            using (var resStream = TestResources.OpenResource("approach-rate-after-overall-difficulty.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var decoded = decoder.Decode(stream);
                Assert.That(decoded.Difficulty.ApproachRate, Is.EqualTo(9));
        ...
        public void TestLegacyAdjacentImplicitCatmullSegmentsAreMerged()
        {
            ...
            using (var resStream = TestResources.OpenResource("adjacent-catmull-segments.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var decoded = decoder.Decode(stream);
        ...
        public void TestLegacyDuplicateInitialCatmullPointIsMerged()
        {
            ...
            using (var resStream = TestResources.OpenResource("catmull-duplicate-initial-controlpoint.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var decoded = decoder.Decode(stream);
                var controlPoints = ((IHasPath)decoded.HitObjects[0]).Path.ControlPoints;
        ...
        public void TestNaNControlPoints()
        {
            ...
            using (var resStream = TestResources.OpenResource("nan-control-points.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var controlPoints = (LegacyControlPointInfo)decoder.Decode(stream).ControlPointInfo;
        ...
        public void TestSamplePointLeniency()
        {
            ...
            using (var resStream = TestResources.OpenResource("sample-point-leniency.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
        ...
        public void TestNewComboAfterBreak()
        {
            ...
            using (var resStream = TestResources.OpenResource("break-between-objects.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var beatmap = decoder.Decode(stream);
        ...
        /// </summary>
        [Test]
        public void TestSpinnerNewComboBetweenObjects([Values("sus", "catch")] string rulesetName)
        {
            var decoder = new LegacyBeatmapDecoder { ApplyOffsets = false };

            using (var resStream = TestResources.OpenResource("spinner-between-objects.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                Ruleset ruleset;
                ...
                // There's no good way to figure out these values other than to compare (in code) with sus!stable...
        ...
        {
            using (var resStream = TestResources.OpenResource("custom-slider-length.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                Ruleset ruleset;
        ...
        public void TestBeatmapDifficultyIsClamped()
        {
            ...
            using (var resStream = TestResources.OpenResource("out-of-range-difficulties.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
        ...
        public void TestManiaBeatmapDifficultyCircleSizeClamp()
        {
            ...
            using (var resStream = TestResources.OpenResource("out-of-range-difficulties-mania.sus"))
            using (var stream = new LineBufferedReader(resStream))
            {
                var decoded = decoder.Decode(stream).Difficulty;
