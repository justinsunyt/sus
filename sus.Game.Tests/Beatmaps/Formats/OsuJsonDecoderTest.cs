...
namespace sus.Game.Tests.Beatmaps.Formats
{
    ...
    {
        private const string normal = "Soleily - Renatus (Gamu) [Insane].sus";
        private const string marathon = "Within Temptation - The Unforgiving (Armin) [Marathon].sus";
        private const string with_sb = "Kozato snow - Rengetsu Ouka (_Kiva) [Yuki YukI].sus";
        ...
        /// <summary>
        /// Reads a .sus file first with a <see cref="LegacyBeatmapDecoder"/>, serializes the resulting <see cref="Beatmap"/> to JSON
        /// and then deserializes the result back into a <see cref="Beatmap"/> through an <see cref="JsonBeatmapDecoder"/>.
        /// </summary>
        /// <param name="filename">The .sus file to decode.</param>
