...
using sus.Framework.Graphics.Rendering.Dummy;
...
namespace sus.Game.Tests.NonVisual.Skinning
{
    [TestFixture]
    public sealed class LegacySkinTextureFallbackTest
    {
        private static object[][] fallbackTestCases =
        {
            ...
            {
                // textures in store
                new[] { "Gameplay/sus/followpoint@2x", "Gameplay/sus/followpoint" },
                // requested component
                "Gameplay/sus/followpoint",
                // returned texture name & scale
                "Gameplay/sus/followpoint@2x", 2
            },
            new object[]
            {
                new[] { "Gameplay/sus/followpoint@2x" },
                "Gameplay/sus/followpoint",
                "Gameplay/sus/followpoint@2x", 2
            },
            new object[]
            {
                new[] { "Gameplay/sus/followpoint" },
                "Gameplay/sus/followpoint",
                "Gameplay/sus/followpoint", 1
            },
            new object[]
            {
                new[] { "Gameplay/sus/followpoint", "followpoint@2x" },
                "Gameplay/sus/followpoint",
                "Gameplay/sus/followpoint", 1
            },
            new object[]
            ...
            new object[]
            {
                ...
                new[] { "Gameplay/sus/followpoint.png" },
                "Gameplay/sus/followpoint.png",
                "Gameplay/sus/followpoint.png", 1
            },
            new object[]
            {
                // Looking up a path with extension specified should also work with @2x sprites.
                new[] { "Gameplay/sus/followpoint@2x.png" },
                "Gameplay/sus/followpoint.png",
                "Gameplay/sus/followpoint@2x.png", 2
            },
        };
        ...
        public void TestReturnNullOnFallbackFailure()
        {
            ...
            var texture = legacySkin.GetTexture("Gameplay/sus/followpoint");
