    ...
    public abstract partial class RealmTest
    {
        ...
        protected static BeatmapSetInfo CreateBeatmapSet(RulesetInfo ruleset)
        {
            ...
            var beatmapSet = new BeatmapSetInfo
            {
                ...
                Files =
                {
                    new RealmNamedFileUsage(createRealmFile(), "test [easy].sus"),
                    new RealmNamedFileUsage(createRealmFile(), "test [normal].sus"),
                    new RealmNamedFileUsage(createRealmFile(), "test [hard].sus"),
                    new RealmNamedFileUsage(createRealmFile(), "test [insane].sus"),
                }
            };
