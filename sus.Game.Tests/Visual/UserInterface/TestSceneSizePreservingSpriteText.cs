...
namespace sus.Game.Tests.Visual.UserInterface
{
    public partial class TestSceneSizePreservingSpriteText : OsuGridTestScene
    {
        ...
        private readonly OsuSpriteText susSpriteText = new OsuSpriteText();
            ...
            : base(1, 2)
        {
            ...
            childContainers[0].Add(susSpriteText);
            childContainers[1].Add(sizePreservingSpriteText);
            susSpriteText.Font = sizePreservingSpriteText.Font = OsuFont.GetFont(Typeface.Venera, weight: FontWeight.Bold, size: 20);
        }

        protected override void Update()
        {
            base.Update();
            susSpriteText.Text = sizePreservingSpriteText.Text = DateTime.Now.ToString(CultureInfo.InvariantCulture);
        }
    }
}
