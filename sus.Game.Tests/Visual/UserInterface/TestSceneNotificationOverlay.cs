    ...
    public partial class TestSceneNotificationOverlay : OsuManualInputManagerTestScene
    {
        ...
        public void TestForwardWithFlingRight()
        {
            ...
            AddStep("post", () =>
            {
                ...
                {
                    Text = @"Welcome to sus!. Enjoy your stay!",
        ...
        {
            SimpleNotification notification = null!;
            AddStep(@"post", () => notificationOverlay.Post(notification = new BackgroundNotification { Text = @"Welcome to sus!. Enjoy your stay!" }));
        ...
        {
            notificationOverlay.Post(new SimpleNotification { Text = @"Welcome to sus!. Enjoy your stay!" });
        }

        private void sendBackgroundNotification()
        {
            notificationOverlay.Post(new BackgroundNotification { Text = @"Welcome to sus!. Enjoy your stay!" });
        }
