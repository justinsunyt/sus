...
3. Third item level 1";
        ...
        public void TestLongMixedList()
        {
            ...
            {
                markdownContainer.Text = @"1. The sus! World Cup is a country-based team tournament played on the sus! game mode.
...
17. The multiplayer chatrooms are subject to the [sus! community rules](/wiki/Rules).
