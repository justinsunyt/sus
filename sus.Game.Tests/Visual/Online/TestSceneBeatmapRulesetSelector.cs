...
namespace sus.Game.Tests.Visual.Online
{
    public partial class TestSceneBeatmapRulesetSelector : OsuTestScene
    {
        ...
        {
            AddSliderStep("sus", 0, 100, 0, v => updateBeatmaps(0, v));
        ...
        public void TestMultipleRulesetsBeatmapSet()
        {
            ...
            AddAssert("sus disabled", () => !selector.ChildrenOfType<BeatmapRulesetTabItem>().Single(t => t.Value.OnlineID == 0).Enabled.Value);
