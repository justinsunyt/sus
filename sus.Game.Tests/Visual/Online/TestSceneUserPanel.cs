...
namespace sus.Game.Tests.Visual.Online
{
    ...
    public partial class TestSceneUserPanel : OsuTestScene
    {
        ...
        public void TestUserActivity()
        {
            ...
            AddStep("solo (sus!)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(0)));
            AddStep("solo (sus!taiko)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(1)));
            AddStep("solo (sus!catch)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(2)));
            AddStep("solo (sus!mania)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(3)));
        ...
        public void TestLocalUserActivity()
        {
            ...
            AddStep("solo (sus!)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(0), API.LocalUser.Value.OnlineID));
            AddStep("solo (sus!taiko)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(1), API.LocalUser.Value.OnlineID));
            AddStep("solo (sus!catch)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(2), API.LocalUser.Value.OnlineID));
            AddStep("solo (sus!mania)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(3), API.LocalUser.Value.OnlineID));
