...
namespace sus.Game.Tests.Visual.Online
{
    public partial class TestSceneLocalUserStatisticsProvider : OsuTestScene
    {
        ...
        {
            AddAssert("sus statistics populated", () => statisticsProvider.GetStatisticsFor(new OsuRuleset().RulesetInfo)!.TotalScore, () => Is.EqualTo(4_000_000));
        ...
        public void TestUserChanges()
        {
            ...
            {
                serverSideStatistics[(1000, "sus")] = new UserStatistics { TotalScore = 5_000_000 };
                serverSideStatistics[(1000, "taiko")] = new UserStatistics { TotalScore = 6_000_000 };
            });

            AddAssert("statistics matches user 1001 in sus",
            ...
            AddAssert("statistics matches user 1000 in sus",
                () => statisticsProvider.GetStatisticsFor(new OsuRuleset().RulesetInfo)!.TotalScore,
        ...
        public void TestRefetchStatistics()
        {
            ...
            AddStep("update statistics server side",
                () => serverSideStatistics[(1001, "sus")] = new UserStatistics { TotalScore = 9_000_000 });
        ...
        private void setUser(int userId, bool generateStatistics = true)
        {
            AddStep($"set local user to {userId}", () =>
            {
                ...
                {
                    serverSideStatistics[(userId, "sus")] = new UserStatistics { TotalScore = 4_000_000 };
