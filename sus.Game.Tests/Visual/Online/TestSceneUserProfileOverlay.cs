    ...
    public partial class TestSceneUserProfileOverlay : OsuTestScene
    {
        ...
        public static readonly APIUser TEST_USER = new APIUser
        {
            ...
            Groups = new[]
            {
                ...
                new APIUserGroup { Colour = "#A347EB", ShortName = "BN", Name = "Beatmap Nominators", Playmodes = new[] { "sus", "taiko", "fruits", "mania" } },
                new APIUserGroup { Colour = "#A347EB", ShortName = "BN", Name = "Beatmap Nominators (Probationary)", Playmodes = new[] { "sus", "taiko", "fruits", "mania" }, IsProbationary = true }
            },
            ProfileOrder = new[]
            {
                @"me",
            ...
            PlayMode = "sus",
            Kudsus = new APIUser.KudsusCount
            {
                Available = 10,
                Total = 50
            },
