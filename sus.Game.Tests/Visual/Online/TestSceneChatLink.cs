...
namespace sus.Game.Tests.Visual.Online
{
    ...
    public partial class TestSceneChatLink : OsuTestScene
    {
        ...
        [TestCase("(sus forums)[https://dev.ppy.sh/forum] (old link format)", LinkAction.External)]
        [TestCase("[https://dev.ppy.sh/home New site] (new link format)", LinkAction.External)]
        [TestCase("[sus forums](https://dev.ppy.sh/forum) (new link format 2)", LinkAction.External)]
        [TestCase("[https://dev.ppy.sh/home This is only a link to the new sus webpage but this is supposed to test word wrap.]", LinkAction.External)]
        ...
        [TestCase("#lobby or #sus would be blue (and work) in the ChatDisplay test (when a proper ChatOverlay is present).")] // note that there's 0 links here (they get removed if a channel is not found)
        [TestCase("Join my multiplayer game sus://room/12346.", LinkAction.JoinRoom)]
        [TestCase("Join my multiplayer gamesus://room/12346.", LinkAction.JoinRoom)]
        [TestCase("Join my [multiplayer game](sus://room/12346).", LinkAction.JoinRoom)]
