...
![play menu](../images/Client/Interface/img/play-menu.jpg ""Main Menu in sus!"")
...
Line after image";
        ...
        public void TestInlineImage()
        {
            ...
            {
                markdownContainer.CurrentPath = "https://dev.ppy.sh";
                markdownContainer.Text = "![sus! mode icon](/wiki/shared/mode/sus.png) sus!";
            });
        }
...
";
        ...
        public void TestWideImageNotExceedContainer()
        {
            AddStep("Add image", () =>
            {
                markdownContainer.CurrentPath = "https://dev.ppy.sh/wiki/sus!_Program_Files/";
                markdownContainer.Text = "![](../images/Client/Program_files/img/file_structure.jpg \"The file structure of sus!'s installation folder, on Windows and macOS\")";
            });
