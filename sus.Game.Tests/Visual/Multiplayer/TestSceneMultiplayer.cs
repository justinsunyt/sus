...
using osuTK.Input;
using ReadyButton = sus.Game.Screens.OnlinePlay.Components.ReadyButton;
...
namespace sus.Game.Tests.Visual.Multiplayer
{
    public partial class TestSceneMultiplayer : ScreenTestScene
    {
        ...
        // This test is failing even after 10 retries (see https://github.com/ppy/sus/actions/runs/6700910613/job/18208272419)
