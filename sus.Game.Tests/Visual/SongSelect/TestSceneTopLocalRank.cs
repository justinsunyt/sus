...
using sus.Game.Screens.Select.Carousel;
...
namespace sus.Game.Tests.Visual.SongSelect
{
    public partial class TestSceneTopLocalRank : OsuTestScene
    {
        ...
        private BeatmapInfo importedBeatmap => beatmapManager.GetAllUsableBeatmapSets().First().Beatmaps.First(b => b.Ruleset.ShortName == "sus");
        ...
        public void TestRulesetChange()
        {
            ...
            AddStep("Change ruleset back", () => Ruleset.Value = rulesets.GetRuleset("sus"));
            AddUntilStep("B rank displayed", () => topLocalRank.DisplayedRank == ScoreRank.B);
        }
