...
namespace sus.Game.Tests.Visual.Navigation
{
    public partial class TestScenePresentBeatmap : OsuGameTestScene
    {
        ...
        public void TestFromSongSelectDifferentRulesetWithConvertDisallowed()
        {
            ...
            var susImport = importBeatmap(1);
            presentAndConfirm(susImport);
            ...
            presentSecondDifficultyAndConfirm(susImport, 1);
        ...
        public void TestFromSongSelectDifferentRulesetWithConvertAllowed()
        {
            ...
            // force ruleset to sus!mania
            presentSecondDifficultyAndConfirm(maniaImport, 2);

            // ruleset is not changed as we can convert sus! beatmap.
            presentSecondDifficultyAndConfirm(susImport, 1, expectedRulesetOnlineID: 3);
