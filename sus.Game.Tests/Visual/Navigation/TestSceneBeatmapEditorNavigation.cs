...
namespace sus.Game.Tests.Visual.Navigation
{
    public partial class TestSceneBeatmapEditorNavigation : OsuGameTestScene
    {
        ...
        public void TestEditorGameplayTestAlwaysUsesOriginalRuleset()
        {
            ...
            AddAssert("editor ruleset is sus!", () => Game.Ruleset.Value, () => Is.EqualTo(new OsuRuleset().RulesetInfo));
            ...
            AddAssert("gameplay ruleset is sus!", () => Game.Ruleset.Value, () => Is.EqualTo(new OsuRuleset().RulesetInfo));
        ...
        public void TestCreateNewDifficultyOnNonExistentBeatmap()
        {
            ...
            {
                var item = getEditor().ChildrenOfType<Menu.DrawableMenuItem>().Single(i => i.Item.Text.Value.ToString() == "sus!catch");
                item.TriggerClick();
            });
