...
namespace sus.Game.Tests.Visual.Navigation
{
    public partial class TestSceneScreenNavigation : OsuGameTestScene
    {
        ...
        public void TestSongSelectScrollHandling()
        {
            ...
            // TODO: this logic can likely be removed when we fix https://github.com/ppy/sus/issues/33379
        ...
        public void TestAttemptPlayBeatmapWrongHashFails()
        {
            ...
            AddStep("change beatmap files", () =>
            {
                ...
                {
                    foreach (var file in Game.Beatmap.Value.BeatmapSetInfo.Files.Where(f => Path.GetExtension(f.Filename) == ".sus"))
                    {
        ...
        public void TestRetryCountIncrements()
        {
            ...
            // todo: see https://github.com/ppy/sus/issues/22220
        ...
        {
            var susAutomationMod = new OsuModAutoplay();

            AddStep("Enable autoplay", () => { Game.SelectedMods.Value = new[] { susAutomationMod }; });
            ...
            AddUntilStep("Mods are restored", () => Game.SelectedMods.Value.Contains(susAutomationMod));
        }
        ...
        public void TestModSelectInput()
        {
            ...
            AddStep("Change ruleset to sus!taiko", () =>
            {
            ...
            AddAssert("Ruleset changed to sus!taiko", () => Game.Toolbar.ChildrenOfType<ToolbarRulesetSelector>().Single().Current.Value.OnlineID == 1);
        ...
        public void TestExitGameFromSongSelect()
        {
            ...
            pushEscape(); // returns to sus! logo
