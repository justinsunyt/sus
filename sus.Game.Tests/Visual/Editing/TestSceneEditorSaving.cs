...
namespace sus.Game.Tests.Visual.Editing
{
    public partial class TestSceneEditorSaving : EditorSavingTestScene
    {
        ...
        public void TestMetadata()
        {
            ...
            AddAssert("Beatmap has correct .sus file path", () => EditorBeatmap.BeatmapInfo.Path == "artist - title (author) [difficulty].sus");
            ...
            AddAssert("Beatmap still has correct .sus file path", () => EditorBeatmap.BeatmapInfo.Path == "artist - title (author) [difficulty].sus");
        }
