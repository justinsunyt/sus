...
namespace sus.Game.Tests.Visual.Editing
{
    public partial class TestSceneOpenEditorTimestamp : OsuGameTestScene
    {
        ...
        public void TestErrorNotifications()
        {
            ...
            AddAssert("ruleset is sus!", () => editorBeatmap.BeatmapInfo.Ruleset.Equals(rulesetInfo));
        ...
        public void TestHandleCurrentScreenChanges()
        {
            ...
            setUpEditor(rulesetInfo);
            AddAssert("is sus! ruleset", () => editorBeatmap.BeatmapInfo.Ruleset.Equals(rulesetInfo));
        ...
        public void TestUrlDecodingOfArgs()
        {
            ...
            AddAssert("is sus! ruleset", () => editorBeatmap.BeatmapInfo.Ruleset.Equals(new OsuRuleset().RulesetInfo));

            AddStep("jump to encoded link", () => Game.HandleLink("sus://edit/00:14:142%20(1)"));
