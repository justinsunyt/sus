...
using osuTK.Input;
using FooterButtonMods = sus.Game.Screens.SelectV2.FooterButtonMods;
using FooterButtonOptions = sus.Game.Screens.SelectV2.FooterButtonOptions;
using FooterButtonRandom = sus.Game.Screens.SelectV2.FooterButtonRandom;
...
namespace sus.Game.Tests.Visual.SongSelectV2
{
    public partial class TestSceneSongSelect : SongSelectTestScene
    {
        ...
        public void TestInvalidRulesetDoesNotEnterGameplay()
        {
            ...
            AddUntilStep("wait for sus beatmap selected", () => Beatmap.Value.BeatmapInfo.Ruleset.OnlineID, () => Is.EqualTo(0));
        ...
        public void TestModSelectCannotBeOpenedAfterConfirmingSelection()
        {
            ...
            AddUntilStep("wait for player", () => Stack.CurrentScreen is PlayerLoader);
            AddAssert("sus! cookie visible", () => this.ChildrenOfType<OsuLogo>().Single().Alpha, () => Is.Not.Zero);
        }
