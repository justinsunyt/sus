...
using susTK.Input;
using Realms;
using CollectionDropdown = sus.Game.Screens.SelectV2.CollectionDropdown;
    ...
    public partial class TestSceneCollectionDropdown : OsuManualInputManagerTestScene
    {
        ...
        private void assertCollectionDropdownContains(string collectionName, bool shouldContain = true) =>
            AddUntilStep($"collection dropdown {(shouldContain ? "contains" : "does not contain")} '{collectionName}'",
                // A bit of a roundabout way of going about this, see: https://github.com/ppy/sus-framework/issues/3871 + https://github.com/ppy/sus-framework/issues/3872
        ...
        {
            // todo: we should be able to use Items, but apparently that's not guaranteed to be ordered... see: https://github.com/ppy/sus-framework/pull/6079
