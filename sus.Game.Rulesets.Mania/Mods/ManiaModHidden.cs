...
using sus.Game.Rulesets.Mania.Skinning;
...
namespace sus.Game.Rulesets.Mania.Mods
{
    ...
    {
        /// <summary>
        /// sus!stable is referenced to 768px.
        /// </summary>
        ...
        private partial class LegacyPlayfieldCover : PlayfieldCoveringWrapper
        {
            ...
            {
                // In sus!stable, the cover is applied in absolute (x768) coordinates from the hit position.
