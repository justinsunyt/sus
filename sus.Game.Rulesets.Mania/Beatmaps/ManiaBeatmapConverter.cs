...
using sus.Game.Rulesets.Mania.Beatmaps.Patterns;
using sus.Game.Rulesets.Mania.Beatmaps.Patterns.Legacy;
            ...
            : base(beatmap!, ruleset)
        {
            ...
            static int getColumnCount(LegacyBeatmapConversionDifficultyInfo difficulty)
            {
                ...
                if (difficulty.TotalObjectCount > 0 && difficulty.EndTimeObjectCount >= 0)
                {
                    ...
                    // In sus!stable, this division appears as if it happens on floats, but due to release-mode
