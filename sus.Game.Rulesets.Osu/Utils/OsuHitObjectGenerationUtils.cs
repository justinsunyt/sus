...
namespace sus.Game.Rulesets.Osu.Utils
{
    public static partial class OsuHitObjectGenerationUtils
    {
        ...
        /// </summary>
        /// <param name="susObject">The object to reflect.</param>
        public static void ReflectHorizontallyAlongPlayfield(OsuHitObject susObject)
        {
            susObject.Position = new Vector2(OsuPlayfield.BASE_SIZE.X - susObject.X, susObject.Position.Y);

            if (susObject is not Slider slider)
                return;
        ...
        /// </summary>
        /// <param name="susObject">The object to reflect.</param>
        public static void ReflectVerticallyAlongPlayfield(OsuHitObject susObject)
        {
            susObject.Position = new Vector2(susObject.Position.X, OsuPlayfield.BASE_SIZE.Y - susObject.Y);
