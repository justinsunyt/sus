...
namespace sus.Game.Rulesets.Osu.Objects.Drawables
{
    public partial class DrawableSliderRepeat : DrawableOsuHitObject
    {
        ...
        internal void SuppressHitAnimations()
        {
            ...
            if (hit)
            {
                // More or less matches stable (see https://github.com/peppy/sus-stable-reference/blob/bb57924c1552adbed11ee3d96cdcde47cf96f2b6/sus!/GameplayElements/HitObjects/Osu/HitCircleOsu.cs#L336-L338)
