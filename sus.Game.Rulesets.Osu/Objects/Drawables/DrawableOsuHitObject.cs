...
namespace sus.Game.Rulesets.Osu.Objects.Drawables
{
    public abstract partial class DrawableOsuHitObject : DrawableHitObject<OsuHitObject>
    {
        ...
        // Must be set to update IsHovered as it's used in relax mod to detect sus hit objects.
        ...
        protected override void ClearNestedHitObjects()
        {
            ...
            // `applyDimToDrawableHitObject` is a clsusre that implicitly captures `this`,
        ...
        private OsuInputManager susActionInputManager;
        internal OsuInputManager OsuActionInputManager => susActionInputManager ??= GetContainingInputManager() as OsuInputManager;
