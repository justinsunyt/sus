...
namespace sus.Game.Rulesets.Osu.Objects.Drawables
{
    public partial class DrawableOsuJudgement : DrawableJudgement
    {
        ...
        public override void Apply(JudgementResult result, DrawableHitObject? judgedObject)
        {
            ...
            if (judgedObject is not DrawableOsuHitObject susObject)
                return;

            AccentColour = susObject.AccentColour.Value;
            ...
            switch (susObject)
            {
                ...
                default:
                    screenSpacePosition = susObject.ToScreenSpace(susObject.OriginPosition);
                    break;
            }

            Scale = new Vector2(susObject.HitObject.Scale);
        }
