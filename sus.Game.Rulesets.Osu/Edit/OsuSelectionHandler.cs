...
namespace sus.Game.Rulesets.Osu.Edit
{
    public partial class OsuSelectionHandler : EditorSelectionHandler
    {
        ...
        public override bool HandleMovement(MoveSelectionEvent<HitObject> moveEvent)
        {
            ...
            // which is unique to sus! due to stacking being applied as a post-processing step.
        ...
        /// <summary>
        /// All sus! hitobjects which can be moved/rotated/scaled.
        /// </summary>
        ...
        /// <summary>
        /// All sus! hitobjects which can be merged.
        /// </summary>
