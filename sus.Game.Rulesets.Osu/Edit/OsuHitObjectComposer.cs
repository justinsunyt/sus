...
namespace sus.Game.Rulesets.Osu.Edit
{
    ...
    public partial class OsuHitObjectComposer : HitObjectComposer<OsuHitObject>
    {
        ...
        private bool snapToVisibleBlueprints(Vector2 screenSpacePosition, out SnapResult snapResult)
        {
            ...
            foreach (var b in blueprints)
            {
                ...
                if (Vector2.Distance(closestSnapPosition, screenSpacePosition) < snapRadius)
                {
                    ...
                    if (b.Item is OsuHitObject susObject && susObject.StackOffset != Vector2.Zero)
                        closestSnapPosition = b.ToScreenSpace(b.ToLocalSpace(closestSnapPosition) - susObject.StackOffset);
        ...
        protected override bool OnMouseDown(MouseDownEvent e)
        {
            ...
            {
                var susSelectionHandler = (OsuSelectionHandler)BlueprintContainer.SelectionHandler;

                if (!susSelectionHandler.SelectedItems.Any())
                {
                    susSelectionHandler.SelectionNewComboState.Value =
                        susSelectionHandler.SelectionNewComboState.Value == TernaryState.False ? TernaryState.True : TernaryState.False;
                    return true;
                }
            }
