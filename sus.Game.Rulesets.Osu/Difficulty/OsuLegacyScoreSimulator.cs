        ...
        private void simulateHit(HitObject hitObject, ref LegacyScoreAttributes attributes)
        {
            ...
            switch (hitObject)
            {
                ...
                case Spinner spinner:
                    // The spinner object applies a lenience because gameplay mechanics differ from sus-stable.
                    // We'll redo the calculations to match sus-stable here...
            ...
            {
                // ReSharper disable once PossibleLossOfFraction (intentional to match sus-stable...)
