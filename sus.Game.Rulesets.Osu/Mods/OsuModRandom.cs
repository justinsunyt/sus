...
namespace sus.Game.Rulesets.Osu.Mods
{
    ...
    public class OsuModRandom : ModRandom, IApplicableToBeatmap
    {
        ...
        {
            if (beatmap is not OsuBeatmap susBeatmap)
                return;
            ...
            var positionInfos = OsuHitObjectGenerationUtils.GeneratePositionInfos(susBeatmap.HitObjects);
            ...
            {
                if (shouldStartNewSection(susBeatmap, positionInfos, i))
                {
            ...
            susBeatmap.HitObjects = OsuHitObjectGenerationUtils.RepositionHitObjects(positionInfos);
        }
