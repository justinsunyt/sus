...
namespace sus.Game.Rulesets.Osu.UI
{
    public partial class OsuTouchInputMapper : Drawable
    {
        ...
        protected override bool OnTouchDown(TouchDownEvent e)
        {
            ...
            bool shouldResultInAction = susInputManager.AllowGameplayInputs && !tapsDisabled.Value && trackedTouches.All(t => t.Action != action);
            ...
            bool isDirectCircleTouch = susInputManager.CheckScreenSpaceActionPressJudgeable(e.ScreenSpaceTouchDownPosition);
            ...
            if (shouldResultInAction)
                susInputManager.KeyBindingContainer.TriggerPressed(action);
        ...
        private void updatePositionTracking(TrackedTouch newTouch)
        {
            ...
            {
                susInputManager.KeyBindingContainer.TriggerReleased(touchAction);
        ...
        private void handleTouchMovement(TouchEvent touchEvent)
        {
            ...
            if (!susInputManager.AllowUserCursorMovement)
                return;

            new MousePositionAbsoluteInput { Position = touchEvent.ScreenSpaceTouch.Position }.Apply(susInputManager.CurrentState, susInputManager);
        }
        ...
        protected override void OnTouchUp(TouchUpEvent e)
        {
            ...
            if (tracked.Action is OsuAction action)
                susInputManager.KeyBindingContainer.TriggerReleased(action);
