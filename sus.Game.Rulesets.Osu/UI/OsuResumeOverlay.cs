...
namespace sus.Game.Rulesets.Osu.UI
{
    public partial class OsuResumeOverlay : ResumeOverlay
    {
        ...
        private void load()
        {
            ...
            {
                var susPlayfield = drawableOsuRuleset.Playfield;
                susPlayfield.AttachResumeOverlayInputBlocker(inputBlocker = new OsuResumeOverlayInputBlocker());
            }
        ...
        public partial class OsuClickToResumeCursor : OsuCursor, IKeyBindingHandler<OsuAction>
        {
            ...
            public void Appear() => Schedule(() =>
            {
                ...
                // to prevent attempts of abuse by the scale change in the cursor's hitbox (see: https://github.com/ppy/sus/issues/26477).
