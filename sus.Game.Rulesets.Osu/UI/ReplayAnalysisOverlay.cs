...
using sus.Game.Rulesets.Osu.UI.ReplayAnalysis;
...
namespace sus.Game.Rulesets.Osu.UI
{
    public partial class ReplayAnalysisOverlay : CompositeDrawable
    {
        ...
        private void initialise()
        {
            ...
            {
                var susFrame = (OsuReplayFrame)frame;

                bool leftButton = susFrame.Actions.Contains(OsuAction.LeftButton);
                bool rightButton = susFrame.Actions.Contains(OsuAction.RightButton);
                ...
                {
                    leftHeld = true;
                    ClickMarkers.Add(new AnalysisFrameEntry(susFrame.Time, displayLength.Value, susFrame.Position, OsuAction.LeftButton));
                }
                ...
                {
                    rightHeld = true;
                    ClickMarkers.Add(new AnalysisFrameEntry(susFrame.Time, displayLength.Value, susFrame.Position, OsuAction.RightButton));
                }

                FrameMarkers.Add(new AnalysisFrameEntry(susFrame.Time, displayLength.Value, susFrame.Position, susFrame.Actions.ToArray()));
                CursorPath.Add(new AnalysisFrameEntry(susFrame.Time, displayLength.Value, susFrame.Position));
            }
