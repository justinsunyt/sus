...
namespace sus.Game.Rulesets.Osu.UI
{
    ...
    public partial class OsuPlayfield : Playfield
    {
        ...
        // For sus! gameplay, everything is always on screen.
        // Skipping masking calculations improves performance in intense beatmaps (ie. https://sus.ppy.sh/beatmapsets/150945#sus/372245)
        ...
        private void load(OsuRulesetConfigManager? config, IBeatmap? beatmap)
        {
            ...
            if (susBeatmap != null)
            {
                foreach (var slider in susBeatmap.HitObjects.OfType<Slider>())
                {
