...
namespace sus.Game.Rulesets.Osu.UI
{
    public partial class OsuPlayfieldAdjustmentContainer : PlayfieldAdjustmentContainer
    {
        ...
        public OsuPlayfieldAdjustmentContainer()
        {
            ...
            // Calculated from sus!stable as 512 (default gamefield size) / 640 (default window size)
        ...
        private partial class ScalingContainer : Container
        {
            ...
            protected override void Update()
            {
                ...
                // is consuming the full game_size. This matches the sus-stable "magic ratio".
                //
